...
class EmbedDefaults():
    ...
    def timeout(self, ctx, guildid):
        ...
        embed.set_thumbnail(url = "https://cdn.discordapp.com/attachments/819496847990063114/819497096692498452/clock.png")
    ...
    def cancel(self, ctx, guildid):
        ...
        ##Add thumbnail / add custom thumbnail system
        embed.set_thumbnail(url = "https://cdn.discordapp.com/attachments/819496847990063114/819497119953584148/x-png-18.png")
